...
import com.tranzo.tranzo_user_ms.service.TokenService;
...
public class userController {
    ...
    public ResponseEntity<ApiResponse> requestOtp(@Valid @RequestBody RequestOtpDto requestOtpDto){
       ...
       return ResponseEntity
               ...
               .body(new ApiResponse(HttpStatus.OK.value(), "OTP Sent successfully."));
    }
    ...
    public ResponseEntity<ApiResponse> verifyOtp(@Valid @RequestBody VerifyOtpDto dto) {
        ...
        if (verified) {
            return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(new ApiResponse(HttpStatus.OK.value(), "OTP verified successfully."));
        } else {
            return ResponseEntity
