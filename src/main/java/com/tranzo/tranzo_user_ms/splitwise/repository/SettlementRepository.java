...
public interface SettlementRepository extends JpaRepository<Settlement, UUID> {
    ...
    List<Settlement> findSettlementsBetweenUsers(@Param("groupId") UUID groupId,
    ...
    List<Settlement> findByGroupIdAndSettledAtBetween(@Param("groupId") UUID groupId,
    ...
    BigDecimal getTotalSettlementAmountForGroup(@Param("groupId") UUID groupId);
    ...
    BigDecimal getTotalReceivedByUserInGroup(@Param("groupId") UUID groupId, @Param("userId") UUID userId);
    ...
    Object[] getSettlementStatisticsForGroup(@Param("groupId") UUID groupId);
    ...
    List<Object[]> getMonthlySettlementTotalsForGroup(@Param("groupId") UUID groupId);
    ...
    @Query("SELECT s.paymentMethod, COALESCE(SUM(s.amount), 0) as total " +
           ...
           "ORDER BY total DESC")
    List<Object[]> getPaymentMethodTotalsForGroup(@Param("groupId") UUID groupId);
    ...
    Page<Settlement> findRecentSettlementsForGroup(@Param("groupId") UUID groupId, Pageable pageable);
    ...
    Page<Settlement> findTopSettlementsByAmountForGroup(@Param("groupId") UUID groupId, Pageable pageable);
    ...
    Page<Settlement> searchSettlements(@Param("groupId") UUID groupId,
    ...
    BigDecimal getNetSettlementForUserInGroup(@Param("groupId") UUID groupId, @Param("userId") UUID userId);
    ...
    long getSettlementCountForGroup(@Param("groupId") UUID groupId);
    ...
    List<Object[]> getUserSettlementPartners(@Param("groupId") UUID groupId, @Param("userId") UUID userId);
}
