...
//
//import com.tranzo.tranzo_user_ms.commons.exception.InvalidPatchRequestException;
...
//
//        userService.deleteUserProfile(userUuid);
//
...
//        assertThrows(InvalidUserIdException.class,
//                () -> userService.deleteUserProfile(UUID.fromString("bad-uuid")));
//    }
//
//    @Test
...
//                .thenReturn(Optional.of(profileEntity));
//
//        UserProfileDto result = userService.updateProfilePicture(userUuid, dto);
//
...
//        assertThrows(InvalidUserIdException.class,
//                () -> userService.updateProfilePicture(UUID.fromString("bad-uuid"), dto));
//    }
//
//    @Test
...
//
//        assertThrows(UserProfileNotFoundException.class,
//                () -> userService.updateProfilePicture(userUuid, dto));
//    }
//
//    // -------------------------------------------------------------------------
...
//                .thenReturn(Optional.of(profileEntity));
//
//        UserProfileDto result = userService.deleteProfilePicture(userUuid);
//
...
//        assertThrows(InvalidUserIdException.class,
//                () -> userService.deleteProfilePicture(UUID.fromString("bad-uuid")));
//    }
//
//    @Test
...
//
//        assertThrows(UserProfileNotFoundException.class,
//                () -> userService.deleteProfilePicture(userUuid));
//    }
//}